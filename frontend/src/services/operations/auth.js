...
export const verify_email = async (email) => {
  try {
    ...
    console.error(
      "Error Verifying email , check your internet connection",
...
export const sendOtp = async (email) => {
  try {
    ...
    console.error(
      "Error Sending otp , check your internet connection",
      error.response?.data || error.message
    );
    throw error;
  }
...
export const fetchProfile = async () => {
  console.log("fetch profile is called");
  try {
...
export const login = async (email, password) => {
  try {
    ...
    console.error(
      "Error login , check your internet connection",
      error.response?.data || error.message
    );
    throw error;
  }
