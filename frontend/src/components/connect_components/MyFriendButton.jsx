...
const MyFriendButton = () => {
  ...
  return (
    <div className=" relative z-30">
      ...
      <div
        className={`fixed top-20 border border-gray-600 rounded-md right-2  h-[620px] w-[300px] md:w-[360px] bg-gradient-to-b from-gray-900 via-gray-800 to-black shadow-2xl transform transition-transform duration-500 ease-in-out ${
      ...
      >
        <div className="p-3 relative w-full mx-auto">
          ...
          <div className=" relative scrollbar-thin z-10">
            ...
            <div
              className={`fixed z-30 top-0 left-0 border border-gray-600 rounded-md   h-[620px] w-[300px] md:w-[360px] bg-gradient-to-b from-gray-900 via-gray-800 to-black shadow-2xl transform transition-transform duration-500 ease-in-out scrollbar-thin scrollbar-thumb-blue-600 scrollbar-track-gray-900 ${
